...
bool sched_init_pcb(struct sched_pcb_s* pcb, func_t entry_point, void* args, uint32 stack_size, int priority) {
...
bool sched_start() {
  ...
  sched_init_pcb(kmain_pcb, NULL, NULL, STACK_SIZE, INIT_PRIORITY);
